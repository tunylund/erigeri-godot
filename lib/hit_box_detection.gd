class_name HitBoxDetection extends Node

static var hit_collision = { "body": build_collisions("res://assets/tsuisoku-collisions.png").body }
static var collisions = {
...
static func get_collisions(interpolation_multiplier):
	var result = {}
...
static func find_color_rect(data, red_color, tilew):
	const feather = 4
...
static func build_collisions(res_path, tilew = 96, tileh = 64):
...
static func reverse_collisions(reversable):
